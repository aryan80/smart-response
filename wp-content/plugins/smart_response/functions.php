...
function smart_register_form(){
	...
	$organizations=$wpdb->get_results("select post_title from ".$table." where post_type='organizations' and post_status='publish'",ARRAY_A);
            ...
            <select name="organization" id="organization">
                ...
                <?php if(!empty($organizations)){
					 foreach($organizations as $valueorg){
						 echo '<option value="'.$valueorg['post_title'].'" >'.$valueorg['post_title'].'</option>';
					 }
				}?>
            </select>
            <p>
